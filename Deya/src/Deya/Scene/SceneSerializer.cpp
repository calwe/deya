...
namespace Deya
{
    ...
    static void SerializeEntity(YAML::Emitter& out, Entity entity)
    {
        ...
        out << YAML::Key << "Entity" << YAML::Value << "123456"; // TODO: Entity ID
    ...
    bool SceneSerializer::Deserialize(const std::string& filepath) 
    {
        ...
        DY_CORE_TRACE("Deserialising scene '{0}'", sceneName);
        ...
        if (entities)
        {
            for (auto entity : entities)
            {
                ...
                DY_CORE_TRACE("Deserialised entity with ID = {0}, name = {1}", uuid, name);
                ...
                {
                    auto& tc = deserialisedEntity.GetComponent<TransformComponent>(); // replace transform component (entities always have transforms)
